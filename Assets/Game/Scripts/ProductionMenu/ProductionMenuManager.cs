...
public class ProductionMenuManager : MonoSingleton<ProductionMenuManager>
{
    ...
    public void SetProductCardList(List<ProductData> productDatas,Barrack barrack = null)
    {
        ClearProducts();
